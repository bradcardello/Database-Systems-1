...
public class Sample
{
	...
	conn = DriverManager.getConnection("jdbc:postgresql://cmps180-db.lt.ucsc.edu/bcardell",
                                       "bcardell", "umbrella60here");  //Making the Connection 
	...
	ResultSet res = stmt.executeQuery(" Select * from mg_customers");    //Query to be executed. Results are stored in ResultSet
	if(res!=null)
